...
class TestPlace(TestCase):
    ...
    @patch('core.placement.Place._get_random_row_and_column', side_effect=[(1, 0), (2, 2)])
    ...
    @patch('core.placement.Place._get_random_row_and_column', side_effect=[(4, 1)])
    ...
    @patch('core.placement.Place._get_random_row_and_column', side_effect=[(0, 0), (0, 2)])
    ...
    @patch('core.placement.Place._get_random_row_and_column', side_effect=[(0, 2), (0, 3)])
